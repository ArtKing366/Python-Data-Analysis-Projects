...
This repository contains exploratory data analysis (EDA) projects using Python to understand datasets, detect patterns, and visualize insights.

---

## Project 01 — Bank Transactions Analysis
